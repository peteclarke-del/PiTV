...
| 11 | Cartoon channel from animated series; family-safe adverts only | cartoon routing in the scanner, `family_safe` flags | `test_cartoons_routed_to_cartoon_channel`, `test_family_safe_adverts_on_cartoon_channel` |
