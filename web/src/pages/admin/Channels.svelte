<script>
  ...
  import { changes, noteChange } from '../../lib/stores.svelte.js';
...
<div class="stack">
  <div class="row">
    ...
    <button onclick={rebalance} disabled={rebalance.busy || !channels?.length}>Rebalance shows across channels</button>
  </div>
