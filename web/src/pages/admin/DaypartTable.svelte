<script>
  ...
  function add() {
    ...
    rows.push({ name: '', start: last ? last.start : '08:00', tv: 1, movie: 0.5, kids: 0.5, max_minutes: null });
  }
</script>

<div class="table-wrap">
  <table class="dp">
    <thead><tr><th>Start</th><th>Name</th><th>TV</th><th>Movie</th><th>Kids</th><th>Max min</th><th></th></tr></thead>
    <tbody>
      {#each rows as r, i (i)}
        <tr>
      ...
      {:else}
        <tr><td colspan="7" class="muted small">No dayparts.</td></tr>
      {/each}
    </tbody>
  </table>
</div>
